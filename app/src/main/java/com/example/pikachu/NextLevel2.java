...
public class NextLevel2 extends AppCompatActivity {
    ...
    private int cycleCount = 0; // Counter for array cycling
...
// Initialize buttons
        ...
        public void onClick(View v) {
            ...
            if (selectedS1 == null) {
                ...
                if (indexS1 == indexA2) {
                    ...
                    // Check if all words are matched, then start new activity
                    if (isAllMatched()) {
                        switchToNextSet();
                        resetWithNewWords();
                    }
    ...
    private void resetWithNewWords() {
        ...
        if (isAllMatched()) {
            ...
            // If cycled twice, start new activity
            if (cycleCount == 2) {
                switchToNextSet();
                // Start new activity
                ...
                switchToNextSet();
                resetWithNewWords(); // Continue with the next cycle
            }
        }
    }
}
