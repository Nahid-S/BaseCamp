...
public class nwvocab extends AppCompatActivity {
    private WebView webView3;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_nwvocab);
                ...
                webView3.setWebViewClient(new nwvocab.MyWebViewClient());

                // Load your initial URL
                webView3.loadUrl("https://translate.google.com/");
            }
