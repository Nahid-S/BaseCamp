...
public class voice13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_voice13);
        ...
        questions13 = getResources().getStringArray(R.array.questions13);
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (currentQuestionIndex < questions13.length - 1) {
    ...
    private void displayCurrentQuestion() {
        questionTextView.setText(questions13[currentQuestionIndex]);
    }
}